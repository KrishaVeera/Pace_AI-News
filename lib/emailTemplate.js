...
function dropBlock(drop, ACCENT, TEXT, MUTED, BG) {
  ...
  return `
              ...
              <p style="margin:0;font-family:'Libre Baskerville',Georgia,serif;font-size:10px;color:${MUTED};font-style:italic;">Select and copy the prompt above to get started</p>`;
}
        ...
        <table width="680" cellpadding="0" cellspacing="0" border="0" style="max-width:680px;width:100%;">
          ...
          <tr>
            <td style="padding:32px 0 28px 0;text-align:center;">
              ...
              <p style="margin:0 0 24px 0;font-family:'Libre Baskerville',Georgia,serif;font-size:13px;font-style:italic;color:${MUTED};">Know what&rsquo;s changed. Build what matters.</p>
