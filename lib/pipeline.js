...
For the decodes, each category should reference whichever of the 3 stories are actually relevant to that track — could be 1 story, could be 2, could be all 3. Don't force one story per category.

Write the decode as a natural 2-3 sentence paragraph that connects the relevant stories to what they mean for someone in that field. If only one story is relevant, focus on that. If two or three stories are relevant, weave them together naturally.

Do NOT assign stories to categories by number or position. Let the content of the stories determine what's relevant to each track.

- Coder decode: what do today's stories mean for someone learning to build or code?
- Data Science decode: what do today's stories mean for someone working with data, models, or pipelines?
- UI/UX decode: what do today's stories mean for someone focused on design and user experience?

For the drops, pick the single most relevant story per category as the inspiration for the build prompt.
...
Return this exact JSON structure:
{
  ...
  "decodes": {
    "coder": "string (2-3 sentences on what today's stories mean for someone learning to build or code)",
    "dataScience": "string (2-3 sentences on what today's stories mean for someone working with data, models, or pipelines)",
    "uiUx": "string (2-3 sentences on what today's stories mean for someone focused on design and user experience)"
  },
  "drops": {
    "coder": {
      "tool": "string",
